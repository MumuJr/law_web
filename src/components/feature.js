        ...
        <div className="grid gap-3 row-gap-3 lg:grid-cols-3 bg-white rounded shadow-2xl p-7 sm:p-10">
          <ul className="space-y-3">
            <li className="flex items-start">
              <span className="mr-1">
                <svg
                  className="w-5 h-5 mt-px text-light-green-900"
                  stroke="currentColor"
                  viewBox="0 0 52 52"
                >
                  <polygon
            ...
            <li className="flex items-start">
              ...
              U.S. Permanent Residency (Adjustment of Status)
            </li>
            <li className="flex items-start">
              <span className="mr-1">
                <svg
          ...
          <ul className="space-y-3">
            <li className="flex items-start">
              ...
              Visas for Survivors of Violence and Trafficking
            </li>
            <li className="flex items-start">
              <span className="mr-1">
                <svg
